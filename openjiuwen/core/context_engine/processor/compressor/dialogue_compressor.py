...
from openjiuwen.core.foundation.llm1 import (
    ...
    ModelRequestConfig, ModelClientConfig, Model, ToolCall, JsonOutputParser
)
...
class DialogueCompressorConfig(BaseModel):
    ...
    """
    Whether to instruct the inference backend to release KV-cache entries corresponding to offloaded messages, 
    reducing GPU memory at the cost of slower re-generation if those messages are needed again.
    """
