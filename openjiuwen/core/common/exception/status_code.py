...
class StatusCode(Enum):
    ...
    COMPONENT_BREAK_EXECUTION_INIT_FAILED = (101180, "Failed to initialize loop controller")

    ## ToolComponent  102000 - 102019
    COMPONENT_TOOL_EXECUTION_INIT_FAILED = (102000, "Tool component failed to bind a valid tool.")
