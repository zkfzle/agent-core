    ...
    def compile(self, session: BaseSession, context: ModelContext = None) -> ExecutableGraph:
        ...
        if isinstance(session, SubWorkflowSession):
            ...
            if main_workflow_config is None:
                raise JiuWenBaseException(StatusCode.COMPONENT_SUB_WORKFLOW_EXECUTION_RUNTIME_ERROR.code,
                                          StatusCode.COMPONENT_SUB_WORKFLOW_EXECUTION_RUNTIME_ERROR.errmsg.format(
