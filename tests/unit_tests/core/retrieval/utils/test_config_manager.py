...
class TestConfigManager:
    ...
    def test_get_knowledge_base_config(self):
        ...
        manager = ConfigManager()
        config = KnowledgeBaseConfig(kb_id="test_kb")
        manager._configs['knowledge_base'] = config

        retrieved_config = manager.get_knowledge_base_config()
        assert retrieved_config.kb_id == "test_kb"
    ...
    def test_update_config(self):
        ...
        assert "KnowledgeBaseConfig" in manager._configs
        assert manager._configs["KnowledgeBaseConfig"].kb_id == "test_kb"
