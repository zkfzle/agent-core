...
class ControllerOutputChunk(OutputSchema):
    ...
    A single data chunk in streaming output, containing index, type, payload, and a flag indicating whether it's the last chunk.
    Used for streaming output scenarios, supporting incremental return of processing results.
