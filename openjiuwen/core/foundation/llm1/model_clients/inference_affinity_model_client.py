...
from openjiuwen.core.foundation.llm1.schema.config import ModelClientConfig, ModelConfig
...
class InferenceAffinityModelClient(BaseModelClient):
    ...
    async def release(
        ...
        Args:
            cache_salt: Cache salt value to identify specific cache
        ...
        try:
            ...
            logger.info(f"Sending release request to {url} with params: {release_params}")
    ...
    def _parse_stream_chunk(self, line: str) -> Optional[AssistantMessageChunk]:
        ...
        try:
            ...
            if "choices" in chunk_data and chunk_data["choices"]:
                ...
                if content or reasoning_content or tool_calls or usage_metadata:
