...
from openjiuwen.core.controller.modules.task_manager import TaskManager, TaskManagerState
...
class TestTaskManager(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.task_manager._priority_index, {})
        self.assertEqual(self.task_manager._parent_to_children, {})
        self.assertEqual(self.task_manager._child_to_parent, {})
        self.assertEqual(self.task_manager._root_tasks, set())
    ...
    def test_add_single_task(self):
        ...
        self.assertIn(self.sample_task.task_id, self.task_manager._priority_index[self.sample_task.priority])
        self.assertIn(self.sample_task.task_id, self.task_manager._root_tasks)
    ...
    def test_add_multiple_tasks(self):
        ...
        for task in self.sample_tasks:
            ...
            self.assertIn(task.task_id, self.task_manager._priority_index[task.priority])
    ...
    def test_add_task_with_parent(self):
        ...
        self.assertIn(self.sample_task.task_id, self.task_manager._parent_to_children["parent_task"])
        self.assertEqual(self.task_manager._child_to_parent[self.sample_task.task_id], "parent_task")
        self.assertNotIn(self.sample_task.task_id, self.task_manager._root_tasks)
    ...
    def test_get_task_by_id(self):
        ...
        result = self.task_manager.get_task(task_id="task1")
    ...
    def test_get_task_by_id_list(self):
        ...
        result = self.task_manager.get_task(task_id=["task1", "task2"])
    ...
    def test_get_task_by_session_id(self):
        ...
        result = self.task_manager.get_task(session_id="session1")
        self.assertEqual(len(result), 2)
    ...
    def test_get_task_by_priority(self):
        ...
        result = self.task_manager.get_task(priority=1)
        self.assertEqual(len(result), 2)
    ...
    def test_get_task_by_status(self):
        ...
        result = self.task_manager.get_task(status=TaskStatus.SUBMITTED)
        self.assertEqual(len(result), 1)
    ...
    def test_get_task_by_user_id(self):
        ...
        result = self.task_manager.get_task(user_id="user1")
        self.assertEqual(len(result), 1)
        self.assertEqual(result[0].task_id, "task1")
    ...
    def test_get_root_tasks(self):
        ...
        result = self.task_manager.get_task(is_root=True)
    ...
    def test_get_task_with_children(self):
        ...
        result = self.task_manager.get_task(task_id="parent", with_children=True)
    ...
    def test_get_task_with_recursive_children(self):
        ...
        result = self.task_manager.get_task(task_id="parent", with_children=True, is_recursive=True)
        self.assertEqual(len(result), 3)  # parent + child + grandchild
    ...
    def test_get_all_tasks(self):
        ...
        result = self.task_manager.get_task()
    ...
    def test_pop_task_by_id(self):
        ...
        result = self.task_manager.pop_task(task_id="task1")
        self.assertEqual(len(result), 1)
        self.assertEqual(result[0].task_id, "task1")
    ...
    def test_pop_task_highest_priority(self):
        ...
        result = self.task_manager.pop_task(priority="highest")
        self.assertEqual(len(result), 1)
    ...
    def test_update_task_priority(self):
        ...
        self.sample_task.priority = 5
        self.task_manager.update_task(self.sample_task)

        self.assertNotIn(self.sample_task.task_id, self.task_manager._priority_index[1])
        self.assertIn(self.sample_task.task_id, self.task_manager._priority_index[5])

    def test_update_task_parent(self):
        ...
        self.task_manager.add_task([parent1, parent2, child])

        # Update child's parent
        child.parent_task_id = "parent2"
        self.task_manager.update_task(child)

        self.assertNotIn(child.task_id, self.task_manager._parent_to_children["parent1"])
        self.assertIn(child.task_id, self.task_manager._parent_to_children["parent2"])
        self.assertEqual(self.task_manager._child_to_parent[child.task_id], "parent2")
    ...
    def test_remove_task_by_id(self):
        ...
        self.task_manager.remove_task(task_id="task1")
        self.assertNotIn("task1", self.task_manager.tasks)
        self.assertNotIn("task1", self.task_manager._priority_index[1])
        self.assertNotIn("task1", self.task_manager._root_tasks)
    ...
    def test_remove_task_with_children(self):
        ...
        self.task_manager.remove_task(task_id="parent", with_children=True)

        self.assertNotIn("parent", self.task_manager.tasks)
        self.assertNotIn("child", self.task_manager.tasks)
        self.assertNotIn("child", self.task_manager._root_tasks)  # Child removed with parent
    ...
    def test_remove_task_promotes_children_to_root(self):
        ...
        self.task_manager.add_task([parent, child])
        self.task_manager.remove_task(task_id="parent")

        # Child should be promoted to root
        self.assertIn("child", self.task_manager._root_tasks)
    ...
    def test_remove_task_by_session_id(self):
        ...
        self.task_manager.remove_task(session_id="session1")
    ...
    def test_remove_task_by_status(self):
        ...
        self.task_manager.remove_task(status=TaskStatus.COMPLETED)
    ...
    def test_set_priority(self):
        ...
        self.assertNotIn("task1", self.task_manager._priority_index[1])
        self.assertIn("task1", self.task_manager._priority_index[5])
    ...
    def test_state_persistence(self):
        ...
        self.assertIn("child", new_manager._parent_to_children["parent"])
        self.assertEqual(new_manager._child_to_parent["child"], "parent")
        self.assertIn("parent", new_manager._root_tasks)
        self.assertNotIn("child", new_manager._root_tasks)
