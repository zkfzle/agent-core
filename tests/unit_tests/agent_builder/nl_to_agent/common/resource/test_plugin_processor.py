...
class TestContextManager(unittest.TestCase):
    ...
    def test_get_retrieved_info(self):
        ...
        retrieved_plugin, retrieved_plugin_dict, retrieved_tool_id_map = PluginProcessor.get_retrieved_info(
            tool_id_list, self.plugin_dict, self.tool_plugin_id_map, need_inputs_outputs=True
        )
        expected_plugin = [
            {
                "tool_id": "mock_tool_1",
        ...
        self.assertEqual(retrieved_plugin_dict, {"mock_plugin_1": self.plugin_dict["mock_plugin_1"]})
        self.assertEqual(retrieved_tool_id_map, {"mock_tool_1": "mock_plugin_1", "mock_tool_2": "mock_plugin_1"})

        retrieved_plugin_no_io, _, _ = PluginProcessor.get_retrieved_info(
            tool_id_list, self.plugin_dict, self.tool_plugin_id_map, need_inputs_outputs=False
        )
        ...
        self.assertEqual(retrieved_plugin_no_io, expected_plugin_no_io)
