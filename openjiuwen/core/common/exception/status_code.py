...
class StatusCode(Enum):
    ...
    PLUGIN_RESPONSE_TOO_BIG_ERROR = (182003, "Plugin restful api  response too big, maxLength={max_length}, actualLength={actual_length}")
    ...
    PLUGIN_RESTFUL_API_METHOD_ERROR = (182006, "Plugin restful api unsupported HTTP method: '{method}', only accepts: {support}")
