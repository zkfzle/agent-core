...
class OptionalSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        ...
        if len(non_none_types) == 1:
            schema = extractor._get_type_schema(non_none_types[0])
...
class UnionSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        args = get_args(type_hint)
        return {
            "anyOf": [extractor._get_type_schema(arg) for arg in args]
        }
...
class ListSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        ...
        if args:
            return {
                "type": "array",
                "items": extractor._get_type_schema(args[0])
            }
        return {"type": "array"}
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        ...
        if args:
            if len(args) == 2 and args[1] is ...:
                ...
                return {
                    "type": "array",
                    "items": [extractor._get_type_schema(arg) for arg in args],
                    "minItems": len(args),
                    "maxItems": len(args)
                }
        return {"type": "array"}
...
class DictSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        ...
        if len(args) == 2:
            return {
                "type": "object",
                "additionalProperties": extractor._get_type_schema(args[1])
            }
        return {"type": "object"}
...
class BaseModelSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        return extractor._get_base_model_schema(type_hint)
...
class EnumSchemaExtractor(TypeSchemaExtractor):
    ...
    def extract(self, type_hint: Any, extractor: 'CallableSchemaExtractor') -> Dict:
        return extractor._get_enum_schema(type_hint)
