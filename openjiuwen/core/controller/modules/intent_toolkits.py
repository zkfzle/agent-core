...
class IntentToolkits:
    ...
    def _low_confidence_intent(self, confidence: float) -> Tuple[Intent, str]:
        return Intent(
            ...
            clarification_prompt="Sorry, I couldn't understand your meaning. Please clarify whether you want to create a new task or modify an existing one.",
    ...
    async def create_task(self, confidence: float, task_description: str) -> Tuple[Intent, str]:
        ...
        ), f"Task ID: {target_task_id}, Task Description: {task_description}, Current Status: Created and submitted for execution"
    ...
    async def modify_task(self, confidence: float, task_id: str, new_task_description: str) -> Tuple[Intent, str]:
        ...
        return Intent(
            ...
            confidence=confidence,
            clarification_prompt=None,
        ), f"Task ID: {target_task_id}, Task Description: {new_task_description}, Current Status: Created and submitted for execution"
