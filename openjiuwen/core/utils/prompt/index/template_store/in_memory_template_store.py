...
from openjiuwen.core.utils.prompt.common.document import Document
from openjiuwen.core.utils.prompt.index.template_store.in_memory import InMemory, TemplateId
