...
class StatusCode(Enum):
    ...
    RETRIEVAL_EMBEDDING_REQUEST_CALL_FAILED = (155004, "Failed to get embedding after {max_retries} attempts: {error_msg}")
    ...
    RETRIEVAL_RETRIEVER_SCORE_THRESHOLD_INVALID = (155201, "Score threshold is only supported when mode='vector': {error_msg}")
