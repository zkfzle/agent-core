...
class StatusCode(Enum):
    ...
    AGENT_CONTROLLER_TASK_PARAM_ERROR = (123006, "agent controller task parameter error, reason: {error_msg}")
    AGENT_CONTROLLER_INTENT_PARAM_ERROR = (123007, "agent controller intention parameter error, reason: {error_msg}")
    AGENT_CONTROLLER_TASK_EXECUTION_ERROR = (123008, "agent controller task execution error, reason: {error_msg}")
    AGENT_CONTROLLER_EVENT_HANDLER_ERROR = (123009, "agent controller event handler error, reason: {error_msg}")
