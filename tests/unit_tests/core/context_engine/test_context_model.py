...
class TestModelContext:
    ...
    async def test_model_context_add_invalid_messages(self):
        ...
        try:
            ...
            assert e.error_code == StatusCode.CONTEXT_MESSAGE_VALIDATION_ERROR.code
    ...
    async def test_model_context_get_messages_with_invalid_size(self):
        ...
        try:
            ...
            assert e.error_code == StatusCode.CONTEXT_MESSAGE_GET_ERROR.code
    ...
    async def test_model_context_pop_messages_with_invalid_size(self):
        ...
        try:
            ...
            assert e.error_code == StatusCode.CONTEXT_MESSAGE_POP_ERROR.code
    ...
    async def test_model_context_get_context_window_with_invalid_size(self):
        ...
        try:
            ...
            assert e.error_code == StatusCode.CONTEXT_WINDOW_GET_ERROR.code
