...
class StatusCode(Enum):
    ...
    # =======================================
    RESOURCE_ID_VALUE_INVALID = (110400, "resource_id is invalid, resource_id='{resource_id}', error='{reason}'")
    RESOURCE_TAG_VALUE_INVALID = (110401, "tag is invalid, tag='{tag}', error='{reason}'")
    RESOURCE_CARD_VALUE_INVALID = (110402, "card is invalid, card='{card}', error='{reason}'")
    RESOURCE_PROVIDER_INVALID = (110403, "resource provider is invalid, card='{card}', error='{reason}'")
    RESOURCE_VALUE_INVALID = (110404, "resource value is invalid, error='{reason}'")
