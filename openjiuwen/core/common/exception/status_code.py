...
class StatusCode(Enum):
    ...
    WORKFLOW_STATE_EXECUTION_ERROR = (100001, "raw_inputs existed, update is invalid")
    ...
    COMPONENT_EXECUTION_RUNTIME_ERROR = (100005, "component [{node_id}] encountered an exception while executing ability [{"
    ...
    WORKFLOW_EXECUTION_TIMEOUT = (100102, "workflow stream exceeded {timeout}s")
