...
class TestPromptAssemble:
    ...
    def test_assemble(self):
        ...
        self.assert_equal(HumanMessage(content="Hi, 张三"), assembled_template[0])
    ...
    def test_template_format(self):
        ...
        self.assert_equal(HumanMessage(content="Hello Alice!"), messages3[0])
        self.assert_equal(AIMessage(content="I'm your assistant for AI."), messages3[1])
