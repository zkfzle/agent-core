...
async def example_sub_agent_delegation():
    ...
    print("Registering sub-agent 'agent-math-specialist' as a tool...")
    ...
    print(f"Sub-agent context: {len(sub_history)} messages")
...
async def example_mcp_main_and_sub_agents():
    ...
    print("--------- browsing agent system prompt ---------")
...
async def main():
    ...
    print("7. Sub-agent registration and task delegation")
    print("\nKey Features:")
    ...
    print("- Sub-agent registration as tools")
