...
class Start(WorkflowComponent):
    ...
    def _check_config(config):
        ...
        if not isinstance(defined_variables, list):
            raise JiuWenBaseException(error_code=StatusCode.COMPONENT_START_EXECUTION_INIT_FAILED.code,
                                      message=StatusCode.COMPONENT_START_EXECUTION_INIT_FAILED.errmsg.format(
