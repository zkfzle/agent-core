...
class GraphRetriever(Retriever):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            chunk_retriever: Chunk retriever (for document chunk retrieval, optional, dynamically created based on mode if not provided)
            triple_retriever: Triple retriever (for triple retrieval, optional, dynamically created based on mode if not provided)
