...
class LLMController(BaseController):
    ...
    async def _get_model(self):
        ...
        if model is None:
            ...
            model = lambda: Model(model_client_config=model_client_config, model_config=model_request_config)
            Runner.resource_mgr.add_model(model_id=model_id, model=model)
