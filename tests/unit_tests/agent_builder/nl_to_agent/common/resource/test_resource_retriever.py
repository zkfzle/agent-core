...
class TestContextManager(unittest.TestCase):
    ...
    @patch.object(ResourceRetriever, "_llm_retrieve", return_value=LLM_CHAT_RESULT)
    ...
    @patch.object(rr.PluginProcessor, "get_retrieved_info", return_value="retrieved_info")
    def test_retrieve(self,
        ...
        self.assertEqual(result, {"plugins": "retrieved_info"})
