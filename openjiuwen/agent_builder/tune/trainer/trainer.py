...
class Trainer:
    ...
    def train(self,
        ...
        result = []
        result.append((progress.current_epoch_score, cur_epoch_evaluated_cases))
        ...
        for _ in progress.run_epoch():
            ...
            for _ in progress.run_batch():
                with self._optimizer as optimizer:
                    ...
                    optimizer.update()
                score, cur_batch_parameters, cur_epoch_evaluated_cases, progress.current_epoch_score = parameter_searcher.search_best(
                    agent=agent,
