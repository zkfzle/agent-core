...
class TestRunnerIntegration:
    def setup_method(self):
        ...
        self._mock_invoke = mock_handle_invoke
        self._mock_stream = mock_handle_stream
    ...
    async def test_agent_normal_lifecycle(self):
        ...
        weather_adapter.server.invoke_handler = self._mock_invoke
        weather_adapter.server.stream_handler = self._mock_stream
