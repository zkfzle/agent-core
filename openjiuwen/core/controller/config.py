...
class ControllerConfig(BaseModel):
    ...
    intent_llm_id: str = Field(
        default="",
        description="LLM model ID for intent recognition. "
                    "Used to identify the LLM model used for intent recognition. "
                    "Default is empty string."
    )
    enable_intent_recognition: bool = Field(
        default=True,
        description="Whether to enable intent recognition. Defaults to True."
    )
