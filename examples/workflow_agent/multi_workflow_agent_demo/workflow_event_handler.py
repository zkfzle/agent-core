...
"""
    ...
    def _validate_and_extract_input(self, event: Event) -> str:
        """验证输入并提取文本"""
...
class EventHandlerWithIntentRecognition(EventHandler):
    ...
    def recognizer(self):
        ...
        if self._recognizer is None:
            if self._config is None or self.context_engine is None or self.task_manager is None or self.ability_manager is None:
                raise RuntimeError(
