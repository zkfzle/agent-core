...
class RestfulApiCard(ToolCard):
    ...
    def validate_method(cls, v: str) -> str:
        ...
        if v_upper not in cls.SUPPORTED_METHODS:
            raise build_error(StatusCode.TOOL_RESTFUL_API_CARD_INVALID,
    ...
    def validate_url(cls, v: str) -> str:
        try:
            ...
            raise build_error(StatusCode.TOOL_RESTFUL_API_CARD_INVALID, cause=e,
...
class RestfulApi(Tool):
    ...
    async def invoke(self, inputs: Input, **kwargs) -> Output:
        ...
        try:
            ...
            raise build_error(StatusCode.TOOL_RESTFUL_API_REQUEST_TIMEOUT_ERROR, cause=e,
    ...
    async def stream(self, inputs: Input, **kwargs) -> AsyncIterator[Output]:
        raise build_error(StatusCode.TOOL_STREAM_NOT_SUPPORT, card=self._card)
    ...
    async def _format_response(self, response: aiohttp.ClientResponse, response_bytes_size_limit):
        ...
        async for chunk in response.content.iter_chunked(1024):
            ...
            if len(content) > response_bytes_size_limit:
                raise build_error(StatusCode.TOOL_RESTFUL_API_RESPONSE_TOO_BIG_ERROR,
