...
class APIEmbedding(Embedding):
    ...
    async def _get_embeddings(self, text: str | List[str], **kwargs) -> List[List[float]]:
        ...
        raise JiuWenBaseException(
            ...
            StatusCode.RETRIEVAL_EMBEDDING_UNREACHABLE_CALL_FAILED.errmsg.format(error_msg="Unreachable code in _get_embeddings"),
        )
    ...
    def _get_embeddings_sync(self, text: str | List[str], **kwargs) -> List[List[float]]:
        ...
        raise JiuWenBaseException(
            StatusCode.RETRIEVAL_EMBEDDING_UNREACHABLE_CALL_FAILED.code,
            StatusCode.RETRIEVAL_EMBEDDING_UNREACHABLE_CALL_FAILED.errmsg.format(error_msg="Unreachable code in _get_embeddings_sync"),
        )
