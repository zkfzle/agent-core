...
class TestToolDecorator:
    ...
    async def test_optional_params_without_defaults(self):
        ...
        self.assertIn("Verified: path=test.txt", result)
        ...
        self.assertNotIn("head", required)
        self.assertNotIn("tail", required)
        self.assertNotIn("line_range", required)
    ...
    async def test_union_str_bytes_param(self):
        ...
        self.assertIn("Verified: path=test.bin", result)
        self.assertIn("mode=bytes", result)
        ...
        self.assertIn("anyOf", content_prop)
    ...
    async def test_tuple_line_range_param(self):
        ...
        self.assertIn("Verified: path=test.txt", result)
        self.assertIn("line_range=[1, 10]", result)
