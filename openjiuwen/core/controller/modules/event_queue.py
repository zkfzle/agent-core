...
class EventQueue:
    ...
    Responsible for publishing and subscribing to events, and dispatching them to the appropriate methods of event handlers.
    ...
    async def publish_event(
        ...
        try:
            ...
            raise build_error(
                StatusCode.CONTROLLER_EVENT_HANDLER_ERROR,
                error_msg=str(e),
                cause=e
            ) from e
