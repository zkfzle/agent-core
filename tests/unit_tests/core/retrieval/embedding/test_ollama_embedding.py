...
class TestOllamaEmbedding:
    ...
    def test_init_model_not_found(self, ollama_config):
    ...
    def test_init_connection_error(self, ollama_config):
    ...
    def test_init_with_extra_headers(self, ollama_config):
    ...
    def test_init_with_custom_params(self, ollama_config):
    ...
    def test_init_base_url_with_trailing_slash(self, ollama_config):
    ...
    @pytest.mark.asyncio
    async def test_get_ollama_embedding_empty_input(self, ollama_config):
        """Test empty input"""
        with patch("requests.get") as mock_get:
            mock_response = Mock()
            mock_response.json.return_value = {
            ...
            model = OllamaEmbedding(config=ollama_config)
            with pytest.raises(ValueError, match="Empty text or list provided"):
                await model._get_ollama_embedding([])

    def test_dimension_property(self, ollama_config):
    ...
    def test_dimension_property_with_running_loop(self, ollama_config):
