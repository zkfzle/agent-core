...
class StatusCode(Enum):
    ...
    MEMORY_STORE_REGISTER_ERROR = (158000, "Failed to register {store_type} to memory engine: {error_msg}")
    MEMORY_SET_CONFIG_ERROR = (158001, "Failed to set {config_type} config: {error_msg}")
    MEMORY_ADD_MEMORY_INFO_ERROR = (158002, "Failed to add {message_type} memory to {store_type}: {error_msg}")
    MEMORY_DELETE_MEMORY_INFO_ERROR = (158003, "Failed to delete {message_type} memory to {store_type}: {error_msg}")
    MEMORY_UPDATE_MEMORY_INFO_ERROR = (158004, "Failed to update {message_type} memory to {store_type}: {error_msg}")
    MEMORY_SEARCH_MEMORY_INFO_ERROR = (158005, "Failed to search {message_type} memory to {store_type}: {error_msg}")
    MEMORY_STORE_INIT_ERROR = (158006, "Failed to init {store_type}: {error_msg}")
    MEMORY_STORE_CONNECT_ERROR = (158007, "Failed to connect {store_type}: {error_msg}")
