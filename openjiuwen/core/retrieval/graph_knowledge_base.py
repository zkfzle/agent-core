        ...
        **kwargs: Any,
        ...
        if not success:
            raise JiuWenBaseException(
                ...
                StatusCode.RETRIEVAL_KB_CHUNK_INDEX_BUILD_EXECUTION_ERROR.errmsg.format(error_msg="Failed to build chunk index"),
            )
            ...
            if triples:
                ...
                if not success:
                    raise JiuWenBaseException(
                        ...
                        StatusCode.RETRIEVAL_KB_TRIPLE_INDEX_BUILD_EXECUTION_ERROR.errmsg.format(error_msg="Failed to build triple index"),
                    )
                else:
            ...
            if not self.graph_retriever:
                if not self.vector_store:
                    raise JiuWenBaseException(
                        ...
                        StatusCode.RETRIEVAL_KB_VECTOR_STORE_NOT_FOUND.errmsg.format(error_msg="vector_store is required for graph retrieval"),
                    )
