...
class ChromaVectorStore(VectorStore):
    ...
    async def remove_collection_from_cache(self, table_name: str):
        """remove collection from cache"""
        if table_name in self.collection_cache:
            del self.collection_cache[table_name]

    async def check_table_name(self, table_name: Optional[str] = None, operation: Optional[str] = None):
        """check table name"""
    ...
    async def add(
        ...
        **kwargs: Any,
        ...
        await self.check_table_name(table_name, "add")
    ...
    async def search(
        ...
        **kwargs: Any,
        ...
        await self.check_table_name(table_name, "search")
    ...
    async def delete(
        ...
        **kwargs: Any,
        ...
        """Delete vectors"""
        table_name = kwargs.get("table_name")
        await self.check_table_name(table_name, "delete")
    ...
    async def delete_table(self, table_name: str) -> bool:
        ...
        await self.remove_collection_from_cache(table_name)
        return True
