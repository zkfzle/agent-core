...
class OperationRegistry:
    ...
    def _lazy_load_operation(cls, name: str, mode: OperationMode):
        ...
        openjiuwen.core.sys_operation.implementations.{mode.value}.{name}_operation
        ...
        """
        try:
            module_path = f"openjiuwen.core.sys_operation.implementations.{mode.value}.{name}_operation"
