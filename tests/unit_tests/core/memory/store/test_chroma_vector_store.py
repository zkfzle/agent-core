...
class TestChromaVectorStore:
    ...
    @staticmethod
    def test_get_collection(chroma_store, persist_directory, table_name):
        """测试获取/创建集合"""
    ...
    @staticmethod
    def test_remove_collection_from_cache(chroma_store, persist_directory, table_name):
        """测试从缓存中移除集合"""
        # 添加集合到缓存
    ...
    @staticmethod
    def test_is_collection_exists(chroma_store, persist_directory, table_name):
        """测试集合是否存在"""
        # 测试集合不存在
