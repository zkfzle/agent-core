...
class StatusCode(Enum):
    ...
    CONTEXT_OPERATION_ERROR = (153001, "context operation error, reason: {error_msg}")
    CONTEXT_VALIDATION_ERROR = (153003, "context engine message validation error, reason: {error_msg}")
