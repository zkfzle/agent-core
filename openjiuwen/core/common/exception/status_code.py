...
class StatusCode(Enum):
    ...
    COMPONENT_SUB_WORKFLOW_INIT_ERROR = (101140, "Sub workflow component init error, as {error_msg}.")
    COMPONENT_SUB_WORKFLOW_EXECUTION_RUNTIME_ERROR = (101141, "Sub workflow component running error, detail: {detail}")

    ## LoopComponent  101150 - 101159
    COMPONENT_LOOP_EXECUTION_NOT_SUPPORT = (101150, "Nested loops are not supported."
                                        " Cannot add LoopComponent to a LoopGroup")
    COMPONENT_EXECUTION_ERROR = (101151, "Loop execution error: {error_msg}")
    COMPONENT_LOOP_EXECUTION_NOT_FOUND = (101152, "Loop group is empty, no components to execute")
    COMPONENT_LOOP_INPUT_INVALID = (101153, "Invalid inputs: {reason}")
    COMPONENT_LOOP_EXECUTION_CONFIG_ERROR = (101155, "Invalid loop type '{loop_type}' for LoopComponent")
    COMPONENT_LOOP_CONFIG_NOT_FOUND = (101156, "LoopGroup config error, as {error_msg}.")

    ## BreakComponent  101180 - 101189
    COMPONENT_BREAK_EXECUTION_INIT_ERROR = (101180, "Failed to initialize loop controller")

    ## ToolComponent  102000 - 102019
    COMPONENT_TOOL_EXECUTION_INIT_ERROR = (102000, "Tool component failed to bind a valid tool.")
    COMPONENT_TOOL_INPUT_PARAM_ERROR = (102001, "Tool component inputs error, as {error_msg}.")

    ## StartComponent  102100 - 102119
    COMPONENT_START_CONFIG_ERROR = (102100, "start component: global variable(s)"
                                                    " defined with no value assigned:  {variable_name}")
    COMPONENT_START_EXECUTION_INIT_FAILED = (102101, "start component create error:  {reason}")

    ## EndComponent  102120 - 102149
    COMPONENT_END_EXECUTION_INIT_FAILED = (102120, "end component create error: {reason}")
