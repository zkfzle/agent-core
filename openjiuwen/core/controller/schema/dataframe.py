...
This module defines DataFrame-related data models for transmitting different types of data in the controller.
...
DataFrame is the basic unit for data transmission in the controller, used for passing data in scenarios such as events, task input/output, etc.
"""
